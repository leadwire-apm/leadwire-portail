 ...
 *
 * Based on DoctrineMongoDBTypeGuesser
 */
class AdminTypeGuesser implements FormTypeGuesserInterface
{
    protected $registry;
    ...
    public function guessType($class, $property)
    {
        ...
        if ($metadata->hasAssociation($property)) {
            ...
            if (isset($mapping['embedded']) && $mapping['embedded'] == true) {
                if (!$multiple) {
                    return new TypeGuess(
                        ...
                        [
                            ...
                            'adminGuesser' => $this,
                            'data_class' => $mapping['targetDocument'],
                        ],
                ...
                if (array_key_exists('mappedBy', $mapping) && isset($mapping['mappedBy'])) {
                    return null;
                } else {
                    return new TypeGuess(
